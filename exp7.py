              ...
              with open(productFileName, 'r') as filep:
                ...
                for item in filep:
                    ...
                    if len(datesplit)>1 and datesplit[1]!=' ' and len(datesplit[1])<=5:
                        ...
                        reviewweights.append(weightMaxHelpVotes)
                        rates.append(float(review[5]))


                newweights = []
                index = 0
                for revweight in reviewweights:
                    ...
                    #print(str(productDates[index])+" "+ " "+str(timeDiff) +" "+ str(revweight)+" "+str(expValue))
                    #print("expValue")
                    #print(expValue)
                    #print("expeValue")
                    #print(expValue)
...
computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",13,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_expo/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_expo/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_expo/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_expo/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_wegighted_date_vote_expo_R/")
