              ...
              with open(productFileName, 'r') as filep:
                ...
                for item in filep:
                    ...
                    if len(datesplit)>1 and datesplit[1]!=' ' and len(datesplit[1])<=5:
                        ...
                        reviewPolarity = ComputeReviewPolarity(review[6])
...
def ComputeReviewPolarity(text):
    filehandle = open("/research/remote/petabyte/users/yassien/Truth_rating_code/test.txt",'a')
    ...
    os.system(command)
    fileToRead = "/research/remote/petabyte/users/yassien/Truth_rating_code/test0_out.txt"
    commentPolarity = 0
    ...
    os.remove("/research/remote/petabyte/users/yassien/Truth_rating_code/test.txt")
    os.remove("/research/remote/petabyte/users/yassien/Truth_rating_code/test0_out.txt")
...
computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",14,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_Baseline/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_Baseline/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_Baseline/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_Baseline/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_Baseline_R/")
