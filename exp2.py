           ...
           try:
              with open(fileName, 'r') as filep:
                for item in filep:
                    ...
                    print("maxVotes after")
                    print(maxVotes)
                    print("numHelpful after")
                    print(numHelpful)
                    weight = 0
                    if maxVotes > 0:
...
def computeRateNumVotesDatesAdjusted(filePath,category,destDirectory):
    print("Procedure to compute product rate per category based on 0.5 NumVotes adjusted and 0.5 date freshness")
    print("Considering "+category)
    print("Started")
    start = datetime.now()
    print(start)
...
def computeTrueRateForAllCategoreis(directory,option,destDirectory):
    ...
    for filename in os.listdir (directory):
        ...
        elif option == 5:#Weighted Mean 0.5 NumVotes adjusted and 0.5 Date Freshness
...
'''
computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",4,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_votes_adjusted/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_votes_adjusted/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_vote_adjusted_average/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_vote_adjusted_average/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_wegighted_vote_adjusted_R/")

'''
#This is 0.5 date and 0.5 UserVote

computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",5,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_adjusted_rating/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_adjusted_rating/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_adjusted_average/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_adjusted_average/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_wegighted_date_vote_adjusted_R/")
