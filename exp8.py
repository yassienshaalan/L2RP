...
def computeRateNumVotesDatesExponential(filePath,category,destDirectory):
           ...
           try:
              with open(productFileName, 'r') as filep:
                ...
                for revweighthelp in reviewHelpfulWeight:
                    ...
                    #print(expValue)
                    #print("--------------")
                    #extra = extrweights[index]
                    #expValue = expValue + extra*expValue
              ...
              '''
                ...
                index = 0
                newFinalRate = 0
                for wi in newweights:
                    newweight = weightDict[wi]
                    numo = numoccurnecess[wi]
                    newweight = newweight/numo
                    newFinalRate = newFinalRate + newweight*rates[index]
                    index = index + 1
              '''


              '''
              totNumReview = len(newweights)

              print("totNumReview")
              print(totNumReview)
              print("numGoodReviews")
              print(numGoodReviews)
              ratioGood = float(float(numGoodReviews)/float(totNumReview))
              print("ratioGood")
              print(ratioGood)
              #numReviesPerProdcut.append(ratioGood)
              print("productId")
              print(productId)
              #print("newFinalRate")
              #print(newFinalRate)
              filehandle.write(productId)
              filehandle.write("\t")
              #overallRateVotes = round(newFinalRate,4)
              print("Before ")
              print(newFinalRate)
              newFinalRate = newFinalRate + newFinalRate*ratioGood
              print("After ")
              print(newFinalRate)
    ...
    for product in products:
        ...
        '''
        print ("Previous Rate")
        print(previousWeights[index])
        print("numReviesPerProdcut[index]")
        print(numReviesPerProdcut[index])
        print("sumweights")
        print(sumweights)
        print("Part 2")
        part2 = float(previousWeights[index]*float(numReviesPerProdcut[index])/sumweights)
        print(part2)
        newFinalRate = previousWeights[index] + part2
...
computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",13,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_expo_fix2/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_expo_fix2/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_expo_fix1/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_expo_fix1/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_wegighted_date_vote_expo_fix_R/")
