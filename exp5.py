...
def computeRateNumVotesDatesAdjusted(filePath,category,destDirectory):
    ...
    print("Procedure to compute product rate per category based on 0.5 NumVotes and 0.5 date freshness Adjusted")
    print("Considering "+category)
    print("Started")
    start = datetime.now()
    print(start)
    ...
    with open(filePath, 'r') as fp:
      for line in fp:
           ...
           try:
              ...
              finalRate = 0.6*overallRateDate + 0.4*overallRateVotes
...
computeTrueRateForAllCategoreis("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories/",12,"/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_adjusted_new_rating_60_40/")

sortRatedCategories("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_weighted_date_vote_adjusted_new_rating_60_40/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_adjusted_new_average_60_40/")

measureDistanceBetweenSalesRankandMajorityVote("/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_sales_rank/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_sorted_weighted_date_vote_adjusted_new_average_60_40/","/research/remote/petabyte/users/yassien/Unique_Products_Stanford_three/categories_differences_wegighted_date_vote_adjusted_new_R_60_40/")
